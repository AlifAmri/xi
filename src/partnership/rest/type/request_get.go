...
func Show(id int64) (*model.PartnershipType, error) {
	m := new(model.PartnershipType)
...
func Get(rq *orm.RequestQuery) (m *[]model.PartnershipType, total int64, err error) {
	// make new orm query
	q, _ := rq.Query(new(model.PartnershipType))
