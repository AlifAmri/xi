...
func (h *Handler) detail(c echo.Context) (e error) {
	...
	if id, e = ctx.Decrypt("id"); e == nil {
		if ctx.ResponseData, e = Show(id, false); e != nil {
			e = echo.ErrNotFound
		}
	}
...
func (h *Handler) permission(c echo.Context) (e error) {
	...
	var id int64
	if id, e = ctx.Decrypt("id"); e == nil {
		if ctx.ResponseData, e = Show(id, true); e != nil {
			e = echo.ErrNotFound
		}
	}
...
func (h *Handler) privilege(c echo.Context) (e error) {
	...
	var pr privilegeRequest
	if pr.ID, e = ctx.Decrypt("id"); e == nil {
		if e = ctx.Bind(&pr); e == nil {
			e = pr.Save()
		}
	}
