...
func Show(id int64) (*model.ItemBatch, error) {
	m := new(model.ItemBatch)
...
func Get(rq *orm.RequestQuery) (m *[]*model.ItemBatch, total int64, err error) {
	// make new orm query
	q, _ := rq.Query(new(model.ItemBatch))
