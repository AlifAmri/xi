...
DROP TABLE IF EXISTS `preparation_plan`;
DROP TABLE IF EXISTS `preparation_plan_item`;
DROP TABLE IF EXISTS `preparation`;
DROP TABLE IF EXISTS `preparation_document`;
DROP TABLE IF EXISTS `preparation_unit`;
DROP TABLE IF EXISTS `preparation_actual`;
